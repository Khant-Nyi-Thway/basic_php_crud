   ...
   // $post_id = "";
    ...
    if(isset($_POST['update_post_button'])){
        ...
        if(!empty($title) && !empty($desc)){
            $query = "UPDATE posts SET title='$title', description='$desc' WHERE id='$titleId' ";
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-title">Posts Edition Form</div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <form action="post-edit.php" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control <?php if($descError != ''): ?> is-invalid <?php endif ?>"><?php echo $desc; ?></textarea>  
